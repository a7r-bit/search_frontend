...
class DocumentCreateDailog extends StatefulWidget {
  final PathPart lastDirectoryPAth;
  const DocumentCreateDailog({super.key, required this.lastDirectoryPAth});

  @override
  State<DocumentCreateDailog> createState() => _DocumentCreateDailogState();
}

class _DocumentCreateDailogState extends State<DocumentCreateDailog> {
              ...
              if (_formKey.currentState?.validate() ?? false) {
                ...
                context.read<DialogBloc>().add(
                  CreateDocument(
                    ...
                    directoryId: widget.lastDirectoryPAth.id!,
                  ),
                );
              }
            },
